...
export async function getSales(date) {
  const url = date
    ? `${API}?action=getSales&date=${encodeURIComponent(date)}&t=${Date.now()}`
    : `${API}?action=getSales&t=${Date.now()}`;
  const res = await fetch(url);
  return res.json();
}
...
export async function createSale(data) {
  const res = await fetch(API, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ action: "createSale", ...data }),
  });
  return res.json();
}
...
export async function getProducts() {
  const res = await fetch(`${API}?action=getProducts&t=${Date.now()}`);
  return res.json();
}
...
export async function createProduct(data) {
  const res = await fetch(API, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ action: "createProduct", ...data }),
  });
  return res.json();
}
...
export async function updateProduct(data) {
  const res = await fetch(API, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ action: "updateProduct", ...data }),
  });
  return res.json();
}
...
export async function getWebsites() {
  const res = await fetch(`${API}?action=getWebsites&t=${Date.now()}`);
  return res.json();
}
...
export async function createWebsite(data) {
  const res = await fetch(API, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ action: "createWebsite", ...data }),
  });
  return res.json();
}
...
export async function updateWebsite(data) {
  const res = await fetch(API, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ action: "updateWebsite", ...data }),
  });
  return res.json();
}
...
export async function updateSale(data) {
  const res = await fetch(API, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ action: "updateSale", ...data }),
  });
  return res.json();
}
